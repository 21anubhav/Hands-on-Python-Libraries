...
st.title('Title -> Anubhav Practice Session')                      # Title
st.header('Header -> Hi Anubhav')                    # Header
st.subheader('Subheader -> Welcome Back')              # SubHeader
st.text('Text -> Lets do it!!!')                        # Text
...
tetxArea=st.text_area('Write something interesting about yourself')
st.write(tetxArea)
